...
namespace Grav\Plugin\SocialFeedExtra\Twig;

use Grav\Common\Page\Collection;
use Grav\Plugin\SocialFeed\Manager\PostManager;

/**
 * PostExtraExtension allows to fetch posts from twig templates.
 */
class PostExtraExtension extends \Twig_Extension
{
    /**
